...
-----------------------------------------------------------------------------*/
// Your solution for 30- here: NOT A CLUE STUDY!! 

// function totalTaskTime(queues, nThreads){
//   let totalTime = 0, short, threads
//   while(queues.length > nThreads){
//     threads = queues.splice(0, nThreads)
//     short = Math.min(...threads)
//     totalTime += short
//     threads = threads.map(t => t - short).filter(t => t)
//     queues = threads.concat(queues)
//   }


//   return totalTime + (queues.length ? Math.max(...queues) : 0);

// }

// totalTaskTime( [2, 2, 3, 3, 4, 4], 2 )
// totalTaskTime( [], 1 )
